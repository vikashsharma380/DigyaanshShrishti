...
export default function NightGuardExcelUpload() {
  ...
  const sendToBackend = async () => {
    const res = await fetch(
      "https://api.digyaanshshrishti.com/api/nightguard/upload-excel",
      {
        method: "POST",
    ...
    >
      ...
      >
        <h3 style={{ marginBottom: "15px", color: "#222", textAlign: "center" }}>
          Block-wise Night Guard Summary
        </h3>
