          ...
          <div id="pdf-wrapper" className="pdf-wrapper">
            ...
            <div className="pdf-page">
              ...
              <div className="letter-body">
                ...
                <b> {data.designation} </b>पद की नियुक्ति प्रदान करते हुए
                प्रसन्नता हो रही है। DIGYAANSH SHRISHTI MAINTENANCE PVT.
                LTD.,प्रभावी तिथि {formatDate(data.deo || "__________")} यह
                नियुक्ति कुछ नियमो और शर्तों पर निर्भर है जो नीचे दी गयी हैं :-
                <br />
                <br />
                1) आप <b> {data.designation || "__________"}</b> के रूप में
                कार्य करेंगे|, आप अपने कर्तव्यों के लिए जिम्मेदार होंगे|,यह
                कंपनी की नीतियों के अधीन होगा।
                <br />
                2) आपका वेतन {data.salary || "__________"}/- CTC है, जो महीने के
                अंतिम तिथि को भुगतान होगा|
                <br />
                3) आपका व्यक्तिगत पारिश्रमिक पूरी तरह से आपके और कंपनी के बीच
                है। हम आपसे अपेक्षा करते हैं कि आप सभी जानकारी और समय-समय पर किए
                गए किसी भी बदलाव को व्यक्तिगत और गोपनीय रूप से सुरक्षित रखेंगे।
              </div>
