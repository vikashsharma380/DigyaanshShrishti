...
const Hospitality = () => {
  ...
  useEffect(() => {
    fetch("https://api.digyaanshshrishti.com/api/page-images/hospitality")
      .then((res) => res.json())
      .then((data) => {
        ...
        <div style={{ maxWidth: 1100, margin: "auto" }}>
          ...
          >
            ...
            <strong style={{ color: "#2d5a7b", fontWeight: 600 }}>
              hospitality staffing and guest support
            </strong>{" "}
            for hotels, institutions, and service facilities.
          </p>
          ...
          >
            Our teams handle front-desk support, housekeeping assistance, and
            daily operations with a focus on comfort and service quality.
          </p>
          ...
          >
            ...
            <li style={{ marginBottom: 12, position: "relative", paddingLeft: 12 }}>
              ...
              Housekeeping and room upkeep support
            </li>
            <li style={{ marginBottom: 12, position: "relative", paddingLeft: 12 }}>
              <span
                style={{
            ...
            <li style={{ position: "relative", paddingLeft: 12 }}>
              ...
              Guest experience and service supervision
            </li>
          </ul>
        </div>
      </main>
